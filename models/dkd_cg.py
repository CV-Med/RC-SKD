...
from models.graph_distillation import Loss_compute
import os
import json
import sys
...
def train(student, teacher, epochs, best_acc, dataset='Brain_3'):
    ...
    for epoch in range(epochs):
        ...
        for step, data in enumerate(train_bar):
            ...
            optimizer.zero_grad()
            loss_total = Loss_compute(beta=5.0, dataset_name=dataset)
        ...
        if best_acc <= val_acc:
            best_acc = val_acc
            model_name = f"./weights/dkd_cg_{best_acc:.3f}_model.pth"
...
if __name__ == '__main__':
    ...
    train(student, teacher, epochs=200, best_acc=0.672, dataset='Brain_3')
